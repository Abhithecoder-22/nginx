  ...
  <li>
    ...
    {/* <a href="/">Web Hosting</a> */}
      ...
      <div className="heading">
        <img src={img1} alt=""  />
        <h1>Logo Designning & Branding</h1>
      </div>
      {/* <secton className="logo-cart">
        <div className="logo-content">
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quos pariatur quisquam laboriosam doloremque id eum sapiente libero eos laudantium corporis labore fugit, nostrum quis, exercitationem neque aut itaque non molestias alias fugiat assumenda? Nihil architecto eveniet aliquid velit, quis, impedit doloribus ipsum cupiditate autem repellat aut delectus perspiciatis repudiandae ex odio voluptates numquam ut omnis nulla non eum libero magni! Officia totam vitae et itaque odio mollitia quod autem sapiente quae perspiciatis ipsam soluta esse nam voluptas cum dolore eius debitis, assumenda, voluptatem cupiditate delectus. Neque harum animi aliquid suscipit, assumenda nostrum delectus iure perferendis natus id similique velit quasi.</p>
          <div className="card">
            <h1>Logo Branding</h1>
            <h1>5,999</h1>
