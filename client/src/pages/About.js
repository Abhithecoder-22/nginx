      ...
      {/* <div className="middle-header">
        ...
        <div className="search-tool">
          <form action="">
            <input
              type="search"
              placeholder="Search for tools, Products"
              style={{ height: 40, width: 300, margin: 10, padding: 10 }}
            />
      ...
      <section className="consultation">
        ...
        <div className="consult-content">
          <p>
            ...
            vitae et. Iure assumenda, maiores culpa itaque maxime facere placeat
            modi mollitia dicta deserunt hic provident aliquid explicabo totam
            in fuga eaque velit, aut corrupti debitis ipsa veritatis! Esse
            ratione Suscipit, aperiam eligendi deleniti nihil nemo adipisci cum
            in cumque voluptatum quos praesentium illum, eum rem. Vitae optio
            non omnis dolores quis ad labore, placeat deserunt nam nulla in
            deleniti. laborum, minus magnam eius exercitationem excepturi
            aspernatur deleniti dolorem nulla consequuntur? Ipsa minima dicta
            quis, facilis beatae quam! Facere possimus inventore pariatur et
            minus dolore magni.{" "}
          </p>
          <form className="request">
            <input
              ...
              id="text"
              placeholder="Name"
              style={{ height: 40, margin: 10, padding: 10, width: 350 }}
            />
            <input
              type="text"
              id="text"
        ...
        <section class="ft-main">
          ...
          <div class="ft-main-item">
            ...
            <form>
              ...
              />
              <button className="btn" type="submit" value="Subscribe">
                SUBSCRIBE
              </button>
            </form>
          </div>
